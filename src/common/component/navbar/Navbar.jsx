  ...
  return (
    <motion.div
      className={clsx(
        ...
        `w-full transition-all duration-300 mx-auto bg-[#E9ECEAfffd0] dark:bg-[#000000d0]  max-w-[1500px]  border-b-[1px] border-neutral-300 dark:border-neutral-800 py-5 px-5 2xl:rounded-3xl  lg:px-10 fixed top-0 z-[99]`
      )}
    >
